import{_ as e,o as d,c as r,e as c}from"./app-abed7c3b.js";const o={},s=c(`<h2 id="docker-compose" tabindex="-1"><a class="header-anchor" href="#docker-compose" aria-hidden="true">#</a> docker compose</h2><h3 id="命令" tabindex="-1"><a class="header-anchor" href="#命令" aria-hidden="true">#</a> 命令</h3><h4 id="启动" tabindex="-1"><a class="header-anchor" href="#启动" aria-hidden="true">#</a> 启动:</h4><pre><code>docker-compose -f ***/docker-compose.yml up -d
...
</code></pre><p>( A***/docker-compose.yml 为全路径的编排文件地址,尽可能在docker-compose.yml这一级目录操作.)</p><h3 id="yml文件编写" tabindex="-1"><a class="header-anchor" href="#yml文件编写" aria-hidden="true">#</a> yml文件编写</h3><h4 id="将外部的docker-compose文件整理在一块" tabindex="-1"><a class="header-anchor" href="#将外部的docker-compose文件整理在一块" aria-hidden="true">#</a> 将外部的docker-compose文件整理在一块</h4><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>version: &#39;2&#39;
services:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>注意:container_name需要和单独的docker-compose文件保持不一样，否则单独启动的时候容器会报错的</strong></p>`,17),a=[s];function i(n,l){return d(),r("div",null,a)}const h=e(o,[["render",i],["__file","docker.html.vue"]]);export{h as default};
