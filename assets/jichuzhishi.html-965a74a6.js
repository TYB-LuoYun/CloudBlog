import{_ as e,r as t,o as p,c,b as s,d as n,e as i,a as o}from"./app-3057e660.js";const l="/assets/image-20240221163346068-6c328d36.png",u="/assets/image-20240221163401806-87bb7dff.png",r="/assets/image-20240221163734870-4bd31f77.png",d="/assets/image-20240221163835558-6dc898ce.png",k="/assets/image-20240222155127414-1f921bbd.png",v="/assets/image-20240222155857129-f6c261e7.png",m="/assets/image-20240222161923899-ea4f74b1.png",b="/assets/image-20240222162031841-fccb11d2.png",h="/assets/image-20240222144945332-1b6a5971.png",g="/assets/image-20240222153212899-bb8c7d85.png",y="/assets/image-20240222153228361-75ae4e73.png",f="/assets/image-20240329164706314-2ff7eebd.png",x="/assets/image-20240329164633459-26f03827.png",w="/assets/image-20240329165508049-ef4ad78e.png",T="/assets/image-20240329170221756-ecdd3a7d.png",E={},q=o('<h1 id="设计模式" tabindex="-1"><a class="header-anchor" href="#设计模式" aria-hidden="true">#</a> 设计模式</h1><p>https://blog.csdn.net/qq_45649807/article/details/124593629#6_184</p><h2 id="创建型设计模式" tabindex="-1"><a class="header-anchor" href="#创建型设计模式" aria-hidden="true">#</a> 创建型设计模式：</h2><ul><li><p>简单工厂：用来生产同一等级结构中的任意产品。（不支持拓展增加产品）</p><p>2个不同的产品类 继承 抽象产品类，由工厂类决定创建哪个对象</p><p><img src="'+l+'" alt="image-20240221163346068"><img src="'+u+'" alt="image-20240221163401806"></p></li></ul><p>具体应用： <img src="'+r+'" alt="image-20240221163835558"> <img src="'+d+'" alt="image-20240221163835558"></p><ul><li><p>工厂方法（又称多态性工厂模式）：用来生产同一等级结构中的固定产品。（支持拓展增加产品）</p><p>多个工厂类继承抽象工厂，实现创建对象的方法，由工厂子类去创建具体的对象，生成对应的产品</p><p><img src="'+k+'" alt="image-20240222155127414"></p></li><li><p>抽象工厂： 用来生产不同产品族的全部产品。（不支持拓展增加产品；支持增加产品族）</p><p>和工厂方法一样，只不过可以创建不同类型的产品。比如既可以生产车吗，又可以生产引擎。</p><p><img src="'+v+'" alt="image-20240222155857129"></p></li></ul><h2 id="结构型" tabindex="-1"><a class="header-anchor" href="#结构型" aria-hidden="true">#</a> 结构型</h2><h3 id="装饰者模式" tabindex="-1"><a class="header-anchor" href="#装饰者模式" aria-hidden="true">#</a> 装饰者模式</h3><p>通过创建一个装饰类来 包装（实现）原始类。装饰类具有与原始类相同的接口，在装饰类中调用原始类的方法，可以在方法中包装额外的功能 <img src="'+m+'" alt="image-20240222161923899"><img src="'+b+'" alt="image-20240222162031841"></p><h1 id="线程" tabindex="-1"><a class="header-anchor" href="#线程" aria-hidden="true">#</a> 线程</h1><h2 id="统一管理项目的线程池" tabindex="-1"><a class="header-anchor" href="#统一管理项目的线程池" aria-hidden="true">#</a> 统一管理项目的线程池</h2><p>频繁的创建、销毁线程和线程池，会给系统带来额外的开销。未经池化及统一管理的线程，则会导致<strong>系统内线程数上限不可控</strong>。</p><ul><li><p>使用单例模式 <img src="'+h+`" alt="image-20240222144945332"></p></li><li><p>自建线程池交给spring管理</p></li></ul><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token annotation punctuation">@Configuration</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>resource：资源名，即限流规则的作用对象。</li><li>limitApp：流控针对的调用来源，若为 default 则不区分调用来源。</li><li>grade：限流阈值类型，QPS 或线程数模式，0 代表根据并发数量来限流，1 代表根据 QPS 来进行流量控制。</li><li>count：限流阈值</li><li>strategy：判断的根据是资源自身，还是根据其它关联资源 (refResource)，还是根据链路入口</li><li>controlBehavior：流控效果（直接拒绝 / 排队等待 / 慢启动模式）</li><li>clusterMode：是否为集群模式</li></ul><h3 id="总结-1" tabindex="-1"><a class="header-anchor" href="#总结-1" aria-hidden="true">#</a> 总结</h3>`,105),S={href:"https://github.com/alibaba/spring-cloud-alibaba",target:"_blank",rel:"noopener noreferrer"},_=s("strong",null,"spring cloud gateway",-1);function L(R,C){const a=t("ExternalLinkIcon");return p(),c("div",null,[q,s("blockquote",null,[s("p",null,[n("sentinel 和 spring cloud gateway 两个框架都是很好的限流框架， 但是在我使用中还没有将"),s("a",S,[n("spring-cloud-alibaba"),i(a)]),n("接入到项目中进行使用， 所以我会选择"),_,n("， 当接入完整的或者接入 Nacos 项目使用 setinel 会有更加好的体验.")])])])}const I=e(E,[["render",L],["__file","jichuzhishi.html.vue"]]);export{I as default};
