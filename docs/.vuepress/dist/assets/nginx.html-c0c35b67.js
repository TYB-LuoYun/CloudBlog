import{_ as e,o as i,c as n,a as s}from"./app-c59649c1.js";const d={},r=s(`<h1 id="记一次网站挂在子目录的处理" tabindex="-1"><a class="header-anchor" href="#记一次网站挂在子目录的处理" aria-hidden="true">#</a> 记一次网站挂在子目录的处理</h1><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>    server{
        listen       6008;
